...
class RecordPortable1TableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        realm = try! Realm()
        results = realm.objects(RecordInfo.self).filter("series = 'Portable1'").sorted(byKeyPath: "lowercase")
