...
class Top508BTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        realm = try! Realm()
        results = realm.objects(RecordInfo.self).sorted(byKeyPath: "button8SkillPoint", ascending: false)
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.skillPoint.text = String(object.button8SkillPoint)
        return cell
    }
