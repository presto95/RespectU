...
extension Notification.Name {
    ...
    static let didReceiveRequestRecords = Notification.Name("DidReceiveRequestRecords")
    static let errorReceiveRequestRecords = Notification.Name("ErrorReceiveRequestRecords")
    static let didReceiveUploadRecords = Notification.Name("DidReceiveUploadRecords")
    static let errorReceiveUploadRecords = Notification.Name("ErrorReceiveUploadRecords")
    static let didReceiveSignIn = Notification.Name("DidReceiveSignIn")
    static let errorReceiveSignIn = Notification.Name("ErrorReceiveSignIn")
