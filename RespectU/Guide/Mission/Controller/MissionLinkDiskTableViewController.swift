...
class MissionLinkDiskTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 0:
            cell.color.backgroundColor=UIColor(red: 180/255.0, green: 110/255.0, blue: 121/255.0, alpha: 1)
        case 1:
            cell.color.backgroundColor=UIColor(red: 163/255.0, green: 153/255.0, blue: 107/255.0, alpha: 1)
        default:
            break
        }
        return cell
