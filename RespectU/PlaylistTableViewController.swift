...
class PlaylistTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.bpm.textColor = UserDefaults.standard.bool(forKey: "night") ? UIColor(red: 1, green: 1, blue: 1, alpha: 1) : UIColor(red: 0, green: 0, blue: 0, alpha: 1)
        // Configure the cell...
    ...
    override func tableView(_ tableView: UITableView, editActionsForRowAt indexPath: IndexPath) -> [UITableViewRowAction]? {
        ...
        let buttonRemovePlaylist=UITableViewRowAction(style: .default, title: "Remove".localized){action, index in
            ...
            NotificationBanner(title: "Removed".localized, subtitle: object.title, leftView: view, style: .success).show()
