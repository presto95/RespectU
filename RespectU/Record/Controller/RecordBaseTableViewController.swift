...
//
//extension RecordBaseTableViewController {
//    func setRank(_ object: SongResponse.Song, rank: String, difficulty: String, button: String) {
//        let key: String = {
//            switch button {
//            case Buttons.button4:
//                switch difficulty {
...
//    }
//
//    func setRate(_ object: SongResponse.Song, rate: String, difficulty: String, button: String) {
//        let value: String
//        if rate.isEmpty {
//            value = "-"
//        } else {
...
//    }
//
//    func setNote(_ object: SongResponse.Song, note: String, difficulty: String, button: String) {
//        let key: String = {
//            switch button {
//            case Buttons.button4:
//                switch difficulty {
...
//    }
//
//    func setHighestSkillPoint(_ object: SongResponse.Song, button: String) {
//        switch button {
//        case Buttons.button4:
