...
class TabBarController : UITabBarController {
    ...
    override func viewDidLoad() {
        ...
        //중요!!!!! dlc 등으로 음악 데이터베이스 추가되면 해당 부분의 성과를 기록할 수 있는 데이터베이스 공간 만들어주어야 함 (initRecord 사용)
        //-> 아래에 공간 있음
        
        //앞으로 DLC 추가나 데이터베이스 수정 시
        //아래 부분에서 처리하지 말고 최신 버전별 추가사항에 코드를 작성하자
        
        
        /*
         성과 기록을 제외한 데이터베이스 부분
         업데이트 때마다 전부 삭제하고 새로 기록하도록 하기
         */
    ...
    func addMission(_ type: String, _ section: String, _ title: String, _ song1title: String, _ song1level: String, _ song1key: String, _ scoreLim: Int, _ feverLim: Int, _ comboLim: Int, _ rateLim: Int, _ breakLim: Int, _ more: String, _ reward: String){
        let mission=MissionInfo()
        mission.type=type; mission.section=section; mission.title=title
        mission.song1title=song1title; mission.song1level=song1level; mission.song1key=song1key
        mission.scoreLim=scoreLim; mission.feverLim=feverLim; mission.comboLim=comboLim; mission.rateLim=rateLim; mission.breakLim=breakLim;
        mission.more=more; mission.reward=reward
        try! realm.write{
            realm.add(mission)
        }
    }
    func addMission(_ type: String, _ section: String, _ title: String, _ song1title: String, _ song1level: String, _ song1key: String, _ song2title: String, _ song2level: String, _ song2key: String, _ scoreLim: Int, _ feverLim: Int, _ comboLim: Int, _ rateLim: Int, _ breakLim: Int, _ more: String, _ reward: String){
        let mission=MissionInfo()
        mission.type=type; mission.section=section; mission.title=title
        mission.song1title=song1title; mission.song1level=song1level; mission.song1key=song1key
        mission.song2title=song2title; mission.song2level=song2level; mission.song2key=song2key
        mission.scoreLim=scoreLim; mission.feverLim=feverLim; mission.comboLim=comboLim; mission.rateLim=rateLim; mission.breakLim=breakLim;
        mission.more=more; mission.reward=reward
        try! realm.write{
            realm.add(mission)
    ...
    func addMission(_ type: String, _ section: String, _ title: String, _ song1title: String, _ song1level: String, _ song1key: String, _ song2title: String, _ song2level: String, _ song2key: String, _ song3title: String, _ song3level: String, _ song3key: String, _ song4title: String, _ song4level: String, _ song4key: String, _ scoreLim: Int, _ feverLim: Int, _ comboLim: Int, _ rateLim: Int, _ breakLim: Int, _ more: String, _ reward: String){
        ...
        mission.song2title=song2title; mission.song2level=song2level; mission.song2key=song2key
        mission.song3title=song3title; mission.song3level=song3level; mission.song3key=song3key
        mission.song4title=song4title; mission.song4level=song4level; mission.song4key=song4key
        mission.scoreLim=scoreLim; mission.feverLim=feverLim; mission.comboLim=comboLim; mission.rateLim=rateLim; mission.breakLim=breakLim;
        mission.more=more; mission.reward=reward
        try! realm.write{
            realm.add(mission)
    ...
    func addMission(_ type: String, _ section: String, _ title: String, _ song1title: String, _ song1level: String, _ song1key: String, _ song2title: String, _ song2level: String, _ song2key: String, _ song3title: String, _ song3level: String, _ song3key: String, _ song4title: String, _ song4level: String, _ song4key: String, _ song5title: String, _ song5level: String, _ song5key: String, _ scoreLim: Int, _ feverLim: Int, _ comboLim: Int, _ rateLim: Int, _ breakLim: Int, _ more: String, _ reward: String){
        ...
        mission.song3title=song3title; mission.song3level=song3level; mission.song3key=song3key
        mission.song4title=song4title; mission.song4level=song4level; mission.song4key=song4key
        mission.song5title=song5title; mission.song5level=song5level; mission.song5key=song5key
        mission.scoreLim=scoreLim; mission.feverLim=feverLim; mission.comboLim=comboLim; mission.rateLim=rateLim; mission.breakLim=breakLim;
        mission.more=more; mission.reward=reward
        try! realm.write{
            realm.add(mission)
    ...
    func addMission(_ type: String, _ section: String, _ title: String, _ song1title: String, _ song1level: String, _ song1key: String, _ song2title: String, _ song2level: String, _ song2key: String, _ song3title: String, _ song3level: String, _ song3key: String, _ song4title: String, _ song4level: String, _ song4key: String, _ song5title: String, _ song5level: String, _ song5key: String, _ song6title: String, _ song6level: String, _ song6key: String, _ scoreLim: Int, _ feverLim: Int, _ comboLim: Int, _ rateLim: Int, _ breakLim: Int, _ more: String, _ reward: String){
        ...
        mission.song4title=song4title; mission.song4level=song4level; mission.song4key=song4key
        mission.song5title=song5title; mission.song5level=song5level; mission.song5key=song5key
        mission.song6title=song6title; mission.song6level=song6level; mission.song6key=song6key
        mission.scoreLim=scoreLim; mission.feverLim=feverLim; mission.comboLim=comboLim; mission.rateLim=rateLim; mission.breakLim=breakLim;
        mission.more=more; mission.reward=reward
        try! realm.write{
            realm.add(mission)
    ...
    func addTrophy(_ series: String, _ titleKor: String, _ contentKor: String, _ titleEng: String, _ contentEng: String, _ rating: String){
        let trophy=TrophyInfo()
        trophy.series=series; trophy.titleKor=titleKor; trophy.contentKor=contentKor; trophy.titleEng=titleEng; trophy.contentEng=contentEng;
    ...
    func removeRecord(_ title: String, _ type: String){
        let record = try! Realm().objects(RecordInfo.self).last!
        try! realm.write{
            switch(type){
            case "nm4":
    ...
    func initRecordDifficulty(_ title: String, _ nm4: Int, _ nm5: Int, _ nm6: Int, _ nm8: Int, _ hd4: Int, _ hd5: Int, _ hd6: Int, _ hd8: Int, _ mx4: Int, _ mx5: Int, _ mx6: Int, _ mx8: Int){
        let record = try! Realm().objects(RecordInfo.self).last!
        try! realm.write{
    ...
    func initRecord(_ series: String, _ title: String){
        let record = RecordInfo()
        record.series=series
        record.title = title; record.nm4Rank="-"; record.nm4Rate="-"; record.nm4Note="-"; record.nm5Rank="-"; record.nm5Rate="-"; record.nm5Note="-"; record.nm6Rank="-"; record.nm6Rate="-"; record.nm6Note="-"; record.nm8Rank="-"; record.nm8Rate="-"; record.nm8Note="-"; record.hd4Rank="-"; record.hd4Rate="-"; record.hd4Note="-"; record.hd5Rank="-"; record.hd5Rate="-"; record.hd5Note="-"; record.hd6Rank="-"; record.hd6Rate="-"; record.hd6Note="-"; record.hd8Rank="-"; record.hd8Rate="-"; record.hd8Note="-"; record.mx4Rank="-"; record.mx4Rate="-"; record.mx4Note="-"; record.mx5Rank="-"; record.mx5Rate="-"; record.mx5Note="-"; record.mx6Rank="-"; record.mx6Rate="-"; record.mx6Note="-"; record.mx8Rank="-"; record.mx8Rate="-"; record.mx8Note="-";
        try! realm.write{
            realm.add(record)
        }
    }
    func addRecord(_ title: String, _ nm4rank: String, _ nm4rate: String, _ nm4note: String, _ nm5rank: String, _ nm5rate: String, _ nm5note: String, _ nm6rank: String, _ nm6rate: String, _ nm6note: String, _ nm8rank: String, _ nm8rate: String, _ nm8note: String, _ hd4rank: String, _ hd4rate: String, _ hd4note: String, _ hd5rank: String, _ hd5rate: String, _ hd5note: String, _ hd6rank: String, _ hd6rate: String, _ hd6note: String, _ hd8rank: String, _ hd8rate: String, _ hd8note: String, _ mx4rank: String, _ mx4rate: String, _ mx4note: String, _ mx5rank: String, _ mx5rate: String, _ mx5note: String, _ mx6rank: String, _ mx6rate: String, _ mx6note: String, _ mx8rank: String, _ mx8rate: String, _ mx8note: String){
        let record = try! Realm().objects(RecordInfo.self).last!
        try! realm.write{
